...
//	virtual void addDebugMesh(std::string name, glm::vec3 xyz, glm::vec3 colour, glm::quat qOrientation, float scale, float lifeTime=0.0f) = 0;
	...
	//{
	//	static ConstAtten unsigned int ANNEALinG_SPHERE_SETTINGS_DEFAULT_NUMBER_OF_POINTS = 1000;
	//	// These are because you can't do static ConstAtten float in header
